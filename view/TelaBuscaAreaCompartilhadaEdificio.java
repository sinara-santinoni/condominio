 ...
 */
public class TelaBuscaAreaCompartilhadaEdificio extends javax.swing.JDialog {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(TelaBuscaAreaCompartilhadaEdificio.class.getName());

    /**
     * Creates new form TelaBuscaCustoNivel1
     */
    public TelaBuscaAreaCompartilhadaEdificio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public javax.swing.JButton getjButtonBuscar1() {
        return jButtonBuscar1;
    }

    public javax.swing.JButton getjButtonSair1() {
        return jButtonSair1;
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                TelaBuscaAreaCompartilhadaEdificio dialog = new TelaBuscaAreaCompartilhadaEdificio(new javax.swing.JFrame(), true);
